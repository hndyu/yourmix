...
import CocktailMixer from "../cocktail-mixer";
...
vi.mock("../../utils/useCocktails", () => ({
	useCocktails: () => mockUseCocktails,
}));
vi.mock("../../utils/useAICocktailGenerator", () => ({
...
vi.mock("../cocktail-search-results", () => ({
...
vi.mock("../cocktail-display-skeleton", () => ({
