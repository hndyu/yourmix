...
/**
 * Optimized Category Navigation component.
 * Uses React.memo to prevent re-renders when other parts of the selector change.
 */
const CategoryNav = React.memo(
	({ categories, activeCategory, onSelectCategory }: CategoryNavProps) => {
		return (
