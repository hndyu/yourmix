...
interface IngredientCardProps {
	 ...
	 * Stable reference required to prevent unnecessary re-renders.
	 */
	onToggle: (ingredient: Ingredient) => void;
	/**
	 * Callback when a detail chip is toggled.
	 * Stable reference required to prevent unnecessary re-renders.
	 */
...
/**
 * Optimized Ingredient Card component.
 * Uses React.memo to prevent re-renders unless selection state or ingredient data changes.
 * Significant performance win in large ingredient lists.
 */
